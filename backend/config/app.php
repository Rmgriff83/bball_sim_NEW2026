...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The base URL of the SPA frontend. Used to build links that are emailed
    | to users (e.g. the password reset link) so they land in the app rather
    | than on the API. Defaults to APP_URL when not set.
    |
    */
