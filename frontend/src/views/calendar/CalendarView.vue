...
// Get in-progress score for user's game
...
<template>
  <div class="calendar-view">
    <!-- Header - Cosmic Style -->
    <header class="page-header card-cosmic">
...
.page-header.card-cosmic::before {
  content: '';
  position: absolute;
  inset: 0;
  background:
