...
export const OWNERS = [
  ...
  { firstName: 'Eleanor',  lastName: 'Whitlock',  team: 'BOS', expectation: 'contender',    patience: 2, moneyConsciousness: 2, wealthSource: 'Old-money biotech heiress who patented half the pills in your medicine cabinet.', blurb: 'Expects to contend for the title every single year.' },
  ...
  { firstName: 'Carl',     lastName: 'Hutchins',  team: 'MIL', expectation: 'contender',    patience: 3, moneyConsciousness: 4, wealthSource: 'Frozen-custard chain magnate who franchised his way to a fortune.', blurb: 'Small market, big ambitions — contend while the core is here.' },
  ...
  { firstName: 'Otis',     lastName: 'Granger',   team: 'MEM', expectation: 'playoffs',     patience: 4, moneyConsciousness: 4, wealthSource: 'Built a barbecue-sauce empire from a single roadside smoker.', blurb: 'Grit-and-grind faithful — earn a playoff spot.' },
  ...
  { firstName: 'Sidney',   lastName: 'Marsh',     team: 'NYK', expectation: 'playoffs',     patience: 2, moneyConsciousness: 2, wealthSource: 'Manhattan real-estate dynasty; owns more of the skyline than he\'ll admit.', blurb: 'Big-market pressure — the fans demand playoff runs.' },
  ...
  { firstName: 'Manny',    lastName: 'Ortega',    team: 'SAC', expectation: 'develop',      patience: 4, moneyConsciousness: 4, wealthSource: 'Almond and wine-country agribusiness baron of the Central Valley.', blurb: 'Ends the drought by building something lasting.' },
  ...
  { firstName: 'Gail',     lastName: 'Sutter',    team: 'POR', expectation: 'rebuild',      patience: 5, moneyConsciousness: 4, wealthSource: 'Tech-IPO money she is patiently letting compound — same as her roster.', blurb: 'Full rebuild — collect assets and grow the future.' },
