export const TEAMS = [
  ...
  { name: 'Boston Seltics', city: 'Boston', abbreviation: 'BOS', conference: 'east', division: 'Atlantic', primary_color: '#007A33', secondary_color: '#BA9653', facilities: { training: 4, medical: 4, scouting: 3, analytics: 4 } },
  { name: 'Brooklyn Netts', city: 'Brooklyn', abbreviation: 'BKN', conference: 'east', division: 'Atlantic', primary_color: '#000000', secondary_color: '#FFFFFF', facilities: { training: 4, medical: 4, scouting: 3, analytics: 5 } },
  { name: 'New York Bricks', city: 'New York', abbreviation: 'NYK', conference: 'east', division: 'Atlantic', primary_color: '#006BB6', secondary_color: '#F58426', facilities: { training: 3, medical: 4, scouting: 3, analytics: 3 } },
  { name: 'Philadelphia 67ers', city: 'Philadelphia', abbreviation: 'PHI', conference: 'east', division: 'Atlantic', primary_color: '#006BB6', secondary_color: '#ED174C', facilities: { training: 4, medical: 3, scouting: 4, analytics: 4 } },
  { name: 'Toronto Velociraptors', city: 'Toronto', abbreviation: 'TOR', conference: 'east', division: 'Atlantic', primary_color: '#CE1141', secondary_color: '#000000', facilities: { training: 3, medical: 3, scouting: 4, analytics: 4 } },
  ...
  { name: 'Atlanta Falcons', city: 'Atlanta', abbreviation: 'ATL', conference: 'east', division: 'Southeast', primary_color: '#E03A3E', secondary_color: '#C1D32F', facilities: { training: 3, medical: 3, scouting: 3, analytics: 3 } },
  { name: 'Charlotte Stingers', city: 'Charlotte', abbreviation: 'CHA', conference: 'east', division: 'Southeast', primary_color: '#1D1160', secondary_color: '#00788C', facilities: { training: 2, medical: 3, scouting: 3, analytics: 2 } },
  { name: 'Miami Warm', city: 'Miami', abbreviation: 'MIA', conference: 'east', division: 'Southeast', primary_color: '#98002E', secondary_color: '#F9A01B', facilities: { training: 5, medical: 5, scouting: 4, analytics: 4 } },
  { name: 'Orlando Tragic', city: 'Orlando', abbreviation: 'ORL', conference: 'east', division: 'Southeast', primary_color: '#0077C0', secondary_color: '#C4CED4', facilities: { training: 3, medical: 3, scouting: 4, analytics: 3 } },
  { name: 'Washington Lizards', city: 'Washington', abbreviation: 'WAS', conference: 'east', division: 'Southeast', primary_color: '#002B5C', secondary_color: '#E31837', facilities: { training: 2, medical: 3, scouting: 2, analytics: 2 } },

  // WESTERN CONFERENCE - NORTHWEST
  { name: 'Denver Chunks', city: 'Denver', abbreviation: 'DEN', conference: 'west', division: 'Northwest', primary_color: '#0E2240', secondary_color: '#FEC524', facilities: { training: 4, medical: 4, scouting: 4, analytics: 4 } },
  ...
  { name: 'Los Angeles Fakers', city: 'Los Angeles', abbreviation: 'LAL', conference: 'west', division: 'Pacific', primary_color: '#552583', secondary_color: '#FDB927', facilities: { training: 5, medical: 5, scouting: 4, analytics: 4 } },
  { name: 'Los Angeles Snippers', city: 'Los Angeles', abbreviation: 'LAC', conference: 'west', division: 'Pacific', primary_color: '#C8102E', secondary_color: '#1D428A', facilities: { training: 4, medical: 4, scouting: 3, analytics: 4 } },
  { name: 'Phoenix Buns', city: 'Phoenix', abbreviation: 'PHX', conference: 'west', division: 'Pacific', primary_color: '#1D1160', secondary_color: '#E56020', facilities: { training: 4, medical: 4, scouting: 3, analytics: 4 } },
  ...
  { name: 'San Antonio Spurts', city: 'San Antonio', abbreviation: 'SAS', conference: 'west', division: 'Southwest', primary_color: '#C4CED4', secondary_color: '#000000', facilities: { training: 4, medical: 4, scouting: 5, analytics: 4 } },
]
