...
export const SYNERGIES = [
  ...
  { id: 15, badge1_id: 'floor_general', badge2_id: 'defensive_leader', synergy_name: 'Complete Leader', description: 'True two-way leader elevates the entire team on both ends.', effect: { condition: 'always', boost: { shotPercentage: 0.05, teamRating: 2, clutchPerformance: 0.08 } }, min_level1: 'gold', min_level2: 'gold' },
